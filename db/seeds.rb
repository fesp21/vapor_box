...
Flavor.create(:name => 'Fruit', :level => '0', :image => 'assets/checkout/fruit.jpg')
Flavor.create(:name => 'Dessert', :level => '0', :image => 'assets/checkout/dessert.jpg')
Flavor.create(:name => 'Tobacco', :level => '0', :image => 'assets/checkout/tobacco.jpg')
Flavor.create(:name => 'Menthol', :level => '0', :image => 'assets/checkout/menthol.jpg')
Flavor.create(:name => 'Fruit', :level => '100', :image => '')
